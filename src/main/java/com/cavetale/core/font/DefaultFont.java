...
public enum DefaultFont implements Font, ComponentLike, AltTextSupplier {
    ...
    // Flags
    BRITAIN("mytems:item/britain", 8, 8, '\uE106', "Flag"),
    SPAIN("mytems:item/spain", 8, 8, '\uE107', "Flag"),
    MEXICO("mytems:item/mexico", 8, 8, '\uE108', "Flag"),
    USA("mytems:item/usa", 8, 8, '\uE109', "Flag"),
    AUSTRIA("mytems:item/austria", 8, 8, '\uE10B', "Flag"),
    BELGIUM("mytems:item/belgium", 8, 8, '\uE10C', "Flag"),
    DENMARK("mytems:item/denmark", 8, 8, '\uE10D', "Flag"),
    EUROPE("mytems:item/europe", 8, 8, '\uE10E', "Flag"),
    FRANCE("mytems:item/france", 8, 8, '\uE10F', "Flag"),
    GERMANY("mytems:item/germany", 8, 8, '\uE110', "Flag"),
    IRELAND("mytems:item/ireland", 8, 8, '\uE111', "Flag"),
    ITALY("mytems:item/italy", 8, 8, '\uE112', "Flag"),
    NORWAY("mytems:item/norway", 8, 8, '\uE113', "Flag"),
    POLAND("mytems:item/poland", 8, 8, '\uE114', "Flag"),
    SWEDEN("mytems:item/sweden", 8, 8, '\uE115', "Flag"),
    SWITZERLAND("mytems:item/switzerland", 8, 8, '\uE116', "Flag"),
    PRIDE_FLAG("mytems:item/pride_flag", 8, 8, '\uE119', "Flag"),
    TRANS_PRIDE_FLAG("mytems:item/trans_pride_flag", 8, 8, '\uE11A', "Flag"),
    ENGLAND("mytems:item/england", 8, 8, '\uE11B', "Flag"),
    CANADA("mytems:item/canada", 8, 8, (char) 0xE163, "Flag"),
    AUSTRALIA("mytems:item/australia", 8, 8, (char) 0xE164, "Flag"),
    NETHERLANDS("mytems:item/netherlands", 8, 8, (char) 0xE165, "Flag"),
    UKRAINE("mytems:item/ukraine", 8, 8, (char) 0xE166, "Flag"),
    BI_FLAG("mytems:item/bi_flag", 8, 8, (char) 0xE1A5, "Flag"),
    FINLAND("mytems:item/finland", 8, 8, (char) 0xE1A6, "Flag"),
    JAPAN("mytems:item/japan", 8, 8, (char) 0xE1A7, "Flag"),
    ARGENTINA("mytems:item/argentina", 8, 8, (char) 0xE1A8, "Flag"),
    // Buttons
