...
public enum DefaultFont implements Font, ComponentLike, AltTextSupplier {
    ...
    // Ranks
    ADMIN("mytems:item/admin", 7, 8, (char) 0xE10A, GlyphPolicy.PUBLIC, "Player Rank", text("[Admin]", AQUA), 64),
    MODERATOR("mytems:item/moderator", 7, 8, (char) 0xE117, GlyphPolicy.PUBLIC, "Player Rank", text("[Moderator]", BLUE), 64),
    TRUSTED("mytems:item/trusted", 7, 8, (char) 0xE118, GlyphPolicy.PUBLIC, "Player Rank", text("[Trusted]", GREEN), 64),
    BUILDER("mytems:item/builder", 7, 8, (char) 0xE11C, GlyphPolicy.PUBLIC, "Player Rank", text("[Builder]", LIGHT_PURPLE), 45),
    GOAT("mytems:item/goat", 7, 8, (char) 0xE11D, GlyphPolicy.PUBLIC, "Player Rank", text("[GOAT]", GOLD), 64),
