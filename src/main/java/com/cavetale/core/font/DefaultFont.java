...
public enum DefaultFont implements Font, ComponentLike, AltTextSupplier {
    ...
    TRUSTED(MYTEMS_ITEM_RANKS, 7, 8, (char) 0xE118, "Player Rank"),
    BUILDER(MYTEMS_ITEM_RANKS, 7, 8, (char) 0xE11C, "Player Rank"),
    GOAT(MYTEMS_ITEM_RANKS, 6, 8, (char) 0xE11D, "Player Rank"),
    CELESTIAL(MYTEMS_ITEM_RANKS, 7, 8, (char) 0xE161, "Player Rank"),
    YOUTUBER(MYTEMS_ITEM_RANKS, 7, 8, (char) 0xE162, "Player Rank"),
