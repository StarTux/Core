...
public enum DefaultFont implements Font, ComponentLike, AltTextSupplier {
    ...
    // Ranks
    ADMIN("mytems:item/admin", 7, 8, (char) 0xE10A, GlyphPolicy.HIDDEN, "Player Rank", text("[Admin]", AQUA), 62),
    MODERATOR("mytems:item/moderator", 7, 8, (char) 0xE117, GlyphPolicy.HIDDEN, "Player Rank", text("[Moderator]", BLUE), 62),
    TRUSTED("mytems:item/trusted", 7, 8, (char) 0xE118, GlyphPolicy.HIDDEN, "Player Rank", text("[Trusted]", GREEN), 62),
    BUILDER("mytems:item/builder", 7, 8, (char) 0xE11C, GlyphPolicy.PUBLIC, "Player Rank", text("[Builder]", LIGHT_PURPLE), 45),
    GOAT("mytems:item/goat", 7, 8, (char) 0xE11D, GlyphPolicy.PUBLIC, "Player Rank", text("[GOAT]", GOLD), 62),
    ...
    PROMO("mytems:item/promo", 7, 8, (char) 0xe15ef, GlyphPolicy.PUBLIC, "Player Rank", text("[Promo]", YELLOW), 62),
    EVENT("mytems:item/event", 7, 8, (char) 0xe15f0, GlyphPolicy.PUBLIC, "Player Rank", text("[Event]", YELLOW), 62),
    // Chat Channels(
    ADMIN_CHAT("mytems:item/admin_chat", 7, 8, (char) 0xe15f1, GlyphPolicy.HIDDEN, "Chat Channel", text("[A]"), 16),
    BUILDER_CHAT("mytems:item/builder_chat", 7, 8, (char) 0xe15f2, GlyphPolicy.HIDDEN, "Chat Channel", text("[B]"), 16),
    COUNCIL_CHAT("mytems:item/council_chat", 7, 8, (char) 0xe15f3, GlyphPolicy.HIDDEN, "Chat Channel", text("[Co]"), 16),
    GLOBAL_CHAT("mytems:item/global_chat", 7, 8, (char) 0xe15f4, GlyphPolicy.HIDDEN, "Chat Channel", text("[G]"), 16),
    INFO_CHAT("mytems:item/info_chat", 7, 8, (char) 0xe15f5, GlyphPolicy.HIDDEN, "Chat Channel", text("(i)"), 16),
    LOCAL_CHAT("mytems:item/local_chat", 7, 8, (char) 0xe15f6, GlyphPolicy.HIDDEN, "Chat Channel", text("<L>"), 16),
    MODERATOR_CHAT("mytems:item/moderator_chat", 7, 8, (char) 0xe15f7, GlyphPolicy.HIDDEN, "Chat Channel", text("[Mc]"), 16),
    PARTY_CHAT("mytems:item/party_chat", 7, 8, (char) 0xe15f8, GlyphPolicy.HIDDEN, "Chat Channel", text("[P]"), 16),
    PRIVATE_CHAT("mytems:item/private_chat", 7, 8, (char) 0xe15f9, GlyphPolicy.HIDDEN, "Chat Channel", text("[PM]"), 16),
    PROMOTION_CHAT("mytems:item/promotion_chat", 7, 8, (char) 0xe15fa, GlyphPolicy.HIDDEN, "Chat Channel", text("[Pr]"), 16),
    TEAM_CHAT("mytems:item/team_chat", 7, 8, (char) 0xe15fb, GlyphPolicy.HIDDEN, "Chat Channel", text("[T]"), 16),
    TRUSTED_CHAT("mytems:item/trusted_chat", 7, 8, (char) 0xe15fc, GlyphPolicy.HIDDEN, "Chat Channel", text("[Tr]"), 16),
    // Logo
