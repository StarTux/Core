...
public enum VanillaEffects implements Font, ComponentLike {
    ...
    INSTANT_DAMAGE(() -> PotionEffectType.INSTANT_DAMAGE, () -> PotionType.HARMING, 0xE172),
    ...
    JUMP_BOOST(() -> PotionEffectType.JUMP_BOOST, () -> PotionType.LEAPING, 0xE175),
    ...
    REGENERATION(() -> PotionEffectType.REGENERATION, () -> PotionType.REGENERATION, 0xE17C),
    ...
    SLOWNESS(() -> PotionEffectType.SLOWNESS, () -> PotionType.SLOWNESS, 0xE180),
    SPEED(() -> PotionEffectType.SPEED, () -> PotionType.SWIFTNESS, 0xE181),
    STRENGTH(() -> PotionEffectType.STRENGTH, () -> PotionType.STRENGTH, 0xE182),
    ...
    public static VanillaEffects of(PotionType type) {
        for (var it : values()) {
            if (it.getPotionType() == type) return it;
        }
        return null;
    }
